...
void TextureArray::setup() {
        ...
        glTexImage3D(GL_TEXTURE_2D_ARRAY, 0, _format, _width, _height, static_cast<GLsizei>(_paths.size()), 0, _format, GL_UNSIGNED_BYTE, nullptr);

        // Upload the first image
        glTexSubImage3D(GL_TEXTURE_2D_ARRAY, 0, 0, 0, 0, static_cast<GLsizei>(_width), static_cast<GLsizei>(_height), 1, _format, GL_UNSIGNED_BYTE, firstImageData);
